...
const socket = io(BACKEND_URL); // Initialize socket
...
function AdminDashboard() {
    ...
    // SINGLE SOURCE OF TRUTH: Auth & Socket logic
    useEffect(() => {
        ...
        <div className="admin-layout">
            ...
            <main className="main-content">
                <header className="top-bar">
                    ...
                    <h1>{activeTab === 'ads' ? 'Media' : 'Playlists'}</h1>
                    <div className="top-actions">
                        {/* <button className="btn-secondary desktop-only" onClick={handleOpenDisplay}>
                            <Icons.External /> View Screen
                        </button> */}

                        <div className="user-profile-box" onClick={() => setShowMenu(!showMenu)} style={{ position: 'relative', cursor: 'pointer' }}>
                            <span className="user-email-full">
                            ...
                            <div className="card form-card">
                                ...
                                <form onSubmit={handleAdSubmit}>
                                    ...
                                    <div className="file-input-wrapper">
                                        ...
                                        <label htmlFor="file">{file ? file.name : 'Choose Video or Image'}</label>
                                    </div>
                            ...
                            <div className="playlist-grid">
                                {playlists.map(p => (
                                    <div className={`card playlist-card ${p.isActive ? 'live-border' : ''}`} key={p._id}>
                                        ...
                                        <p>{p.ads.length} Items Integrated</p>
